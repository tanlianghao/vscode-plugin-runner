...
import { pulldownListCodeBuilder, widgetBuilder } from './template/list_page/widget';
import {cubitCodeBuilder, pulldownListCubitCodeBuilder, pulldownListStateCodeBuilder, stateCodeBuilder} from './template/list_page/cubit';
...
async function generateListPageCode(data: vscode.Uri): Promise<any> {
	...
	const quickPickOptions = [
		...
		{
			label: "筛选搜索列表",
			description: "具有筛选和搜索功能的pulldown列表页面",
